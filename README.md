...
It'll also tell the user how much they can spend for the rest of the month to stay in budget (which is a custom value decided by your app, e.g. `₹100000`.
...
2. `expensetracker.py`: The main application logic.

## ✅ Tasks

1. Create the `expense.py` class.
2. Create the `expensetracker.py` file and write the main logic for the app.
